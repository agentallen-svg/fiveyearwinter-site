...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-ash text-charcoal font-body">
          ...
          >
            ...
            <motion.p
              animate={{
                ...
                textShadow: [
                  '0 0 4px rgba(255,255,255,0), 0 0 12px rgba(210,230,255,0), 0 0 28px rgba(170,205,255,0), 0 0 55px rgba(130,175,255,0)',
      ...
      <section className="py-24 px-6 bg-[#1a1814]">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-sm uppercase tracking-[0.3em] text-stone/80 mb-4">Debut EP</p>
              ...
              <p className="text-linen/80 leading-relaxed mb-8 font-body">
      ...
      {/* Production Credits */}
      <section className="py-14 px-6 bg-[#1a1814] border-t border-stone/10">
        <div className="max-w-4xl mx-auto">
          <motion.div
          ...
          >
            <div className="text-center">
              <p className="text-xs uppercase tracking-[0.35em] text-stone/70 mb-2">Produced &amp; Mixed by</p>
              <a href="http://nathanyarborough.com/#credits" target="_blank" rel="noopener noreferrer" className="font-display text-xl text-linen/90 tracking-wide hover:text-linen transition-colors duration-300">Nathan Yarborough</a>
            </div>
            <div className="hidden sm:block w-px h-10 bg-stone/20" />
            <div className="text-center">
              <p className="text-xs uppercase tracking-[0.35em] text-stone/70 mb-2">Mastered by</p>
              <a href="https://www.machineshopprod.com/discography" target="_blank" rel="noopener noreferrer" className="font-display text-xl text-linen/90 tracking-wide hover:text-linen transition-colors duration-300">Gene &ldquo;Machine&rdquo; Freeman</a>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-ink">
        <div className="max-w-2xl mx-auto">
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-sm uppercase tracking-[0.3em] text-stone/90 text-center mb-8"
          >
            Music
          </motion.p>
      ...
      <section className="py-24 px-6 bg-[#1a1814]">
        <div className="max-w-3xl mx-auto text-center">
          <motion.p
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-sm uppercase tracking-[0.3em] text-stone/90 mb-12"
          >
            The Band
          </motion.p>
      ...
      <section className="py-24 px-6 bg-ink">
        <div className="max-w-3xl mx-auto">
          <motion.p
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-sm uppercase tracking-[0.3em] text-stone/90 text-center mb-12"
          >
            Upcoming Shows
          </motion.p>
            ...
            {[
              ...
              >
                <div>
                  ...
                  <p className="text-stone/90 text-sm mt-1 uppercase tracking-widest">{show.venue}</p>
                  {show.support && <p className="text-stone/70 text-sm mt-1">w/ {show.support}</p>}
                </div>
                {show.tickets ? (
                  <a
                    href={show.tickets}
                  ...
                  <span className="text-xs uppercase tracking-widest text-stone/60 self-start sm:self-center">Coming Soon</span>
                )}
              </motion.div>
            ))}
      ...
      <footer className="py-12 px-6 border-t border-stone/10 bg-[#0f0e0c]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-xs uppercase tracking-widest text-stone/90">
            {[
              { label: 'Merch', href: 'https://fiveyearwinter.printful.me/' },
